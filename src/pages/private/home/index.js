...
setSubmitting(true);
        try {
            ...
            //update stok produk dengan transactions
...
setSubmitting(false);
    ...
    return <>
        <Typography
            ...
            component="h1"
            paragraph
        >Buat Transaksi Baru</Typography>
        <Grid container spacing={5}>
            <Grid item xs>
                <TextField label="No Transaksi" value={transaksi.no} InputProps={{
                    readOnly: true
                }} />
            </Grid>
            <Grid item>
                <Button variant="contained"
                    color="primary" onClick={simpanTransaksi} disabled={isSubmitting}>
                            ...
                            Object.keys(transaksi.items).map(k => {
                                ...
                                return (
                                    <TableRow key={k}>
                                        ...
                                        <TableCell><TextField className={classes.inputJumlah} value={item.jumlah} type="number" onChange={handleChangeJumlah(k)}
                                        disabled={isSubmitting} /></TableCell>
                ...
                <List
                    ...
                    subheader={
                        <ListSubheader component="div">
                            <TextField autoFocus label="Cari Produk" fullWidth margin="normal" onChange={e => {
                ...
                >
                    {
                        produkItems.map((produkDoc) => {
                            ...
                            return <ListItem
                                ...
                                key={produkDoc.id}
                                button disabled={produkData.stok < 1|| isSubmitting} >
                                {
                                    produkData.foto ?

                                        <ListItemAvatar>
                                            <Avatar
                                                src={produkData.foto} alt={produkData.nama} />
